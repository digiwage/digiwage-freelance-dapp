...
- `contracts/FreelanceHub.sol` -- the contract source. Solidity 0.8.26
  ...
  an older EVM version here just because some other Qtum contract examples
...
qtuminfo-api. Posting/applying/hiring/ordering won't work there since
...
redeploy via `qtum-cli createcontract`, then update:
